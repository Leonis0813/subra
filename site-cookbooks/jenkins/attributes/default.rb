...
default[:jenkins][:jobs] = %w[ alterf alterf-deploy regulus regulus-deploy algieba algieba-module_test algieba-function_test algieba-deploy algieba-system_test chort ]
